const userId = document.fosignup.fouserid;
const ward = document.fosignup.ward;
const timeInWard = document.fosignup.duration;
const surName = document.fosignup.fosurname;
const lastName = document.fosignup.folname;
const dob = document.fosignup.dob;
const niNo = document.fosignup.nin;
const telPhone = document.fosignup.phoneno;
const activity = document.fosignup.activities;
const homeType = document.fosignup.residencetype;
const homeDirect = document.fosignup.homedirections;
const regDate = document.fosignup.foDateReg;
const passWord = document.fosignup.fopwd;
